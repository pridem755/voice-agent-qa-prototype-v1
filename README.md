...
The speech pipeline maintains a Deepgram WebSocket connection for real-time transcription. It uses VAD for adaptive end-of-speech detector and this allows the patient to allow the agent to speak without budging in.
